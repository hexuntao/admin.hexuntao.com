...
export const APP_TITLE = 'Hexuntao Blog Admin'
export const BLOG_URL = `https://hexuntao.com`
export const GITHUB_REPO_URL = 'https://github.com/hexuntao/admin.hexuntao.com'
